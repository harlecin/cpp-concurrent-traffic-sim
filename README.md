...
* OpenCV >= 4.1
  * The OpenCV 4.1.0 source code can be found [here](https://github.com/opencv/opencv/tree/4.1.0)or on Ubuntu can be installed with `sudo apt install libopencv-dev`
* gcc/g++ >= 5.4 
